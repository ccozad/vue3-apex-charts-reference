...
This walkthrough sets up a Vue 3 + Apex Charts + Bootstrap project from an
empty slate. It mirrors how this repo was originally created.

> **Note:** The walkthrough below uses plain JavaScript, matching how the
> project was first built. The live repo has since been migrated to TypeScript
> and newer tooling (Vite, Vitest, ESLint flat config). The concepts are
> identical; if you scaffold a TypeScript project, answer "Yes" to the
> TypeScript prompt and author the chart files as `<script setup lang="ts">`.
